...
I am a **Software Engineer** specializing in low-level C++ systems, modern cross-platform mobile development, and scalable cloud architectures. 

My engineering approach focuses on understanding the underlying mechanics of software systems. Whether I am optimizing rendering pipelines, designing responsive mobile applications, or deploying serverless cloud backends, my priority is writing robust, performant, and resource-efficient code.

---

## 🛠️ Tech Stack & Expertise

* **Systems & Graphics:** C/C++ (Modern standards), Pointer Arithmetic, Memory Management (Stack/Heap allocations), Concurrency & Multithreading (Mutexes, Deadlock Prevention), OpenGL, GLSL.
* **Mobile & Cloud:** Flutter, Android lifecycle management, AWS (Amplify, Lambda, Cognito, EC2, S3), Serverless Architectures, .NET.
* **Embedded & Hardware:** Microcontroller programming (bare-metal), Serial Protocols (UART, I2C), Hardware integration.
...
A lightweight, standalone C++ matrix library designed for linear algebra and machine learning operations. Supports dot products, slicing, concatenation, and Xavier initialization.

### 🧠 [DAG-NN-CPP](https://github.com/TheK1ER/DAG-NN-CPP)
A lightweight neural network framework built from scratch in C++. Implements a Directed Acyclic Graph (DAG) architecture to support custom branching and merging operations.
