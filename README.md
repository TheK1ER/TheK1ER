...
My engineering approach centers on understanding and optimizing the underlying mechanics of software systems. Whether I am architecting complex computational graphs for neural networks, optimizing rendering pipelines, designing responsive mobile interfaces, or deploying secure serverless cloud layers, my priority is writing robust, performant, and resource-efficient code.
...
* **Machine Learning & Parallel Computing:** Custom Computational Graphs (DAG), Parallel computing (CUDA GPU acceleration), PyTorch, TensorFlow, OpenCV (Computer Vision).
